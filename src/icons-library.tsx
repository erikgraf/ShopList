...
export const ICONS: Record<string, () => ReactNode> = {
  ...
  nudeln: () => (
    <>
      <path d="M4 13 H20 C20 17 16 19.5 12 19.5 C8 19.5 4 17 4 13 Z" />
      <path d="M3 13 C3 12 21 12 21 13" />
      <path d="M6.5 12 C8.5 10 10.5 13 12 11 C13.5 9 15.5 12 17.5 10.5" />
      <path d="M9 8.5 C8 9.5 9 10.5 8.2 11.5" />
      <path d="M14 8 C13 9 14 10 13.2 11" />
    </>
  ),
