...
export const ICONS: Record<string, () => ReactNode> = {
  ...
  haehnchen: () => (
    <>
      <path d="M14.5 6 C17 7 18 10 16.5 12.5 C15.5 14 13.5 14.5 12 13.8 L8.5 17.3 C7.8 18 6.5 18 6 17 C5.6 16 6 15 6.7 14.5 L10.2 11 C9.5 9.5 10 7.5 11.5 6.5 C12.5 5.8 13.5 5.6 14.5 6 Z" />
      <circle cx="5.5" cy="17.5" r="1.2" />
      <circle cx="7" cy="18.8" r="1.1" />
    </>
  ),
  steak: () => (
    <>
      <path d="M5 9 C5 7.5 6 7 7.5 7 H16 C18 7 19 8.5 19 10.5 V13 C19 15.5 17.5 17 15 17 H7.5 C6 17 5 16 5 14 Z" />
      <path d="M8 10 Q10 9.5 12 10.5" />
      <path d="M9 13 Q11 12.5 13 13.5" />
    </>
  ),
  hackfleisch: () => (
    <>
  ...
  garnele: () => (
    <>
      <path d="M15 8 C17.5 8 18 11 15.5 12.5 C12 14.5 8 13 7 16 C6.5 17.5 8 18.5 9.5 18 L11 17.3" />
      <path d="M9 13.5 L8.5 14.5" />
      <path d="M11 12.8 L10.7 14" />
      <path d="M13 12 L12.8 13.2" />
      <path d="M15 8 L17.5 6.5" />
  ...
  muesli: () => (
    <>
      <path d="M4 12 Q12 10 20 12 Q19 18 12 18 Q5 18 4 12 Z" />
      <circle cx="9" cy="13" r="0.6" />
      <circle cx="12" cy="13.5" r="0.6" />
      <circle cx="15" cy="13" r="0.6" />
      <circle cx="10.5" cy="15" r="0.5" />
      <circle cx="13.5" cy="15" r="0.5" />
      <path d="M7 11.5 Q8 10.5 9 11.5" />
    </>
  ),
  nuss: () => (
    <>
  ...
  brezel: () => (
    <>
      <path d="M12 6 Q8 6 6.5 9 Q5 12.5 7.5 14.5 Q9.5 16 11 13.5 Q12 12 12 12" />
      <path d="M12 6 Q16 6 17.5 9 Q19 12.5 16.5 14.5 Q14.5 16 13 13.5 Q12 12 12 12" />
      <path d="M7.5 14.5 L13 18.5" />
      <path d="M16.5 14.5 L11 18.5" />
      <path d="M11 18.5 Q12 19 13 18.5" />
    </>
  ),
  croissant: () => (
    <>
