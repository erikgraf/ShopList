...
export const CURATED_CATALOG: Product[] = [
  ...
  { id: 'local:saft', name: 'Saft', category: 'getraenke', stores: ['rewe', 'edeka', 'aldi', 'lidl'] },
  ...
  { id: 'local:traubensaft', name: 'Traubensaft', category: 'getraenke', stores: ['rewe', 'edeka', 'aldi', 'lidl'] },
  { id: 'local:tomatensaft', name: 'Tomatensaft', category: 'getraenke', stores: ['rewe', 'edeka', 'aldi', 'lidl'] },
  { id: 'local:karottensaft', name: 'Karottensaft', category: 'getraenke', stores: ['rewe', 'edeka', 'aldi', 'lidl'] },
  { id: 'local:kirschsaft', name: 'Kirschsaft', category: 'getraenke', stores: ['rewe', 'edeka', 'aldi', 'lidl'] },
  { id: 'local:birnensaft', name: 'Birnensaft', category: 'getraenke', stores: ['rewe', 'edeka', 'aldi', 'lidl'] },
  { id: 'local:ananassaft', name: 'Ananassaft', category: 'getraenke', stores: ['rewe', 'edeka', 'aldi', 'lidl'] },
  { id: 'local:grapefruitsaft', name: 'Grapefruitsaft', category: 'getraenke', stores: ['rewe', 'edeka'] },
  { id: 'local:maracujasaft', name: 'Maracujasaft', category: 'getraenke', stores: ['rewe', 'edeka', 'aldi', 'lidl'] },
  { id: 'local:apfelschorle', name: 'Apfelschorle', category: 'getraenke', sizes: [1, 6, 12], stores: ['rewe', 'edeka', 'aldi', 'lidl'] },
  { id: 'local:schorle', name: 'Schorle', category: 'getraenke', stores: ['rewe', 'edeka', 'aldi', 'lidl'] },
  { id: 'local:smoothie', name: 'Smoothie', category: 'getraenke', stores: ['rewe', 'edeka', 'aldi', 'lidl'] },
  { id: 'local:limonade', name: 'Limonade', category: 'getraenke', sizes: [1, 6, 12], stores: ['rewe', 'edeka', 'aldi', 'lidl'] },
